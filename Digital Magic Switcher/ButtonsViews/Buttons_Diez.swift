...
struct boton: View{
    ...
    func checkLengthChannel(_ valor:Int) -> String{
        ...
        if(nombre[id] == "Color Bars\0" || nombre[id] == "Color 1\0" || nombre[id] == "Color 2\0" || nombre[id] == "Color 3\0" || nombre[id] == "Color 4\0" || nombre[id] == "Clean Feed 1\0" || nombre[id] == "Clean Feed 2\0" || nombre[id] == "Clean Feed 3\0" || nombre[id] == "Clean Feed 4\0" || nombre[id] == "Preview\0" || nombre[id] == "Program\0" || nombre[id] == "Media Player 1\0" || nombre[id] == "Media Player 2\0" || nombre[id] == "Media Player 3\0" || nombre[id] == "Media Player 4\0" || nombre[id] == "Media Player 1 Key\0" || nombre[id] == "Media Player 2 Key\0"  || nombre[id] == "Media Player 3 Key\0" || nombre[id] == "Media Player 4 Key\0" || nombre[id] == "ME 1 Key 1 Mask\0" || nombre[id] == "ME 1 Key 2 Mask\0" || nombre[id] == "ME 1 Key 3 Mask\0" || nombre[id] == "ME 1 Key 4 Mask\0" || nombre[id] == "ME 2 Key 1 Mask\0" || nombre[id] == "ME 2 Key 2 Mask\0" || nombre[id] == "ME 2 Key 3 Mask\0" || nombre[id] == "ME 2 Key 4 Mask\0" || nombre[id] == "ME 3 Key 1 Mask\0" || nombre[id] == "ME 3 Key 2 Mask\0" || nombre[id] == "ME 3 Key 3 Mask\0" || nombre[id] == "ME 3 Key 4 Mask\0" || nombre[id] == "ME 4 Key 1 Mask\0" || nombre[id] == "ME 4 Key 2 Mask\0" || nombre[id] == "ME 4 Key 3 Mask\0" || nombre[id] == "ME 4 Key 4 Mask\0" || nombre[id] == "DSK 1 Mask\0" || nombre[id] == "DSK 2 Mask\0" || nombre[id] == "DSK 3 Mask\0" || nombre[id] == "DSK 4 Mask\0" || nombre[id] == "SuperSource 1\0" || nombre[id] == "SuperSource 2\0" || nombre[id] == "ME 1 PGM\0" || nombre[id] == "ME 1 PVW\0" || nombre[id] == "ME 2 PGM\0" || nombre[id] == "ME 2 PVW\0" || nombre[id] == "ME 3 PGM\0" || nombre[id] == "ME 3 PVW\0" || nombre[id] == "ME 4 PGM\0" || nombre[id] == "ME 4 PVW\0" || nombre[id] == "SuperSource\0"){
            ...
            if(nombre[id] == "SuperSource 1\0" || nombre[id] == "SuperSource\0"){
